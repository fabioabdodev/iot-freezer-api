...
export const metadata: Metadata = {
  title: 'Solucoes | Virtuagil',
  description:
    'Conheca os modulos da Virtuagil para monitoramento, automacao e visibilidade operacional com crescimento por etapas.',
  alternates: {
    canonical: '/solucoes',
  },
  openGraph: {
    title: 'Solucoes | Virtuagil',
    description:
      'Modulos de temperatura, acionamento, consumo e gases para evolucao operacional com proposta comercial clara.',
