...
4. Criar `/opt/iot-virtuagil-api/.env.prod` com base em `deploy/swarm/.env.prod.example`.
...
1. Build + push de imagens para GHCR:
   - `ghcr.io/fabioabdodev/iot-virtuagil-api/api:latest`
...
cat /opt/iot-virtuagil-api/.env.prod
```
