  ...
  const clients = [
    {
      id: 'virtuagil',
      name: 'Virtuagil Demo',
      adminName: 'Administrador Virtuagil',
      alertContactName: 'Operacao Virtuagil',
      document: '12.345.678/0001-90',
      phone: '31988887777',
      adminPhone: '31988887777',
      alertPhone: '31988887777',
      billingName: 'Financeiro Virtuagil',
      billingPhone: '31988887777',
    ...
    },
    {
      ...
      adminName: 'Administrador Cliente Teste',
      alertContactName: 'Operacao Cliente Teste',
      document: '98.765.432/0001-10',
      phone: '31999990000',
      adminPhone: '31999990000',
      alertPhone: '31999990000',
      billingName: 'Financeiro Cliente Teste',
      billingPhone: '31999990000',
  ...
  for (const client of clients) {
    await prisma.client.upsert({
      ...
      update: {
        ...
        alertContactName: client.alertContactName,
        adminPhone: client.adminPhone,
        alertPhone: client.alertPhone,
